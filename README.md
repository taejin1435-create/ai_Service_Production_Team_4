...
| 구간 | MAE | RMSE | 비고 |
|------|-----|------|------|
| 0~30분 | 42.59분 | — | XGBoost 단독 |
| 31~90분 | 55.32분 | — | 전환 구간 |
| 91분+ | 23.23분 | 33.33분 | XGBoost + LSTM 통합 ✅ |

가동 종료 판단이 이루어지는 후반 구간(91분+)에서 MAE 23.23분 달성 (목표: <30분)
...
| 사이클당 평균 절감 | 3.4분 |
| 연간 절감 전력 | 14,531 kWh |
| 연간 절감 전기료 | 1,598,426원 |

> 12월 테스트셋 시뮬레이션 기반 실측치. STOP 미발생 사이클(43.9%) 포함 평균. 재학습 후 `models/report.md`에 자동 갱신.
